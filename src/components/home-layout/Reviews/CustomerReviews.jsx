...
export default function CustomerReviews() {
  ...
  return (
    <section className="w-full bg-neutral-50 py-16 px-6 md:px-16 overflow-hidden">
      {/* Header */}
      ...
      <div className="relative max-w-7xl mx-auto mt-10 overflow-hidden">
        ...
        >
          {reviews.map((r) => (
            <div key={r.id} className="flex-shrink-0 w-full md:w-1/3 px-3">
              <div className="bg-white rounded-2xl shadow-sm border border-neutral-200 p-6 flex flex-col justify-between h-full">
                <div>
      ...
      {/* Pagination Buttons with progress bar */}
      <PaginationButtons
        progress={progress}
