...
export default function NewsletterSection() {
  return (
    <section className="relative max-w-7xl mx-auto bg-black text-white rounded-4xl overflow-hidden flex flex-col md:flex-row items-center justify-between px-0 md:px-0 pt-9">
      {/* Background Pattern */}
      <div
