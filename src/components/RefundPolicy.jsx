...
import { refundPolicy } from "../lib/policies"; // import the refund policy object
...
export default function RefundPolicy() {
  return (
    <div className="p-4 mt-12">
      ...
      <p className="text-gray-500 text-center mb-8">{refundPolicy.subtitle}</p>
      ...
      <div className="max-w-7xl rounded-4xl bg-neutral-200 items-center justify-center mx-auto p-8 shadow-md">
        <p className="text-gray-400 flex text-sm mb-6">
          ...
          Updated as of&nbsp;
          <span className="font-medium">{refundPolicy.updated}</span>
        </p>
