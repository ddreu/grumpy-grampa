  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 md:w-1/2 flex flex-col items-start justify-center text-left px-6 md:px-10 space-y-4">
        ...
        <p className="text-sm text-neutral-700">Enter the 6 digit code.</p>

        <form className="w-full space-y-3">
          <input
            type="email"
            placeholder="6 digit code"
            className="w-full px-4 py-3 mb-10 border border-gray-300 rounded-lg text-neutral-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-neutral-900"
          />
          <button
            type="submit"
